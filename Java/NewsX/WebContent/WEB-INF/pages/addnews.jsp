...
<div class="input-group">
  ...
  <form:input type="text" class="form-control" path="headlines" placeholder="Enter Headlines" aria-describedby="sizing-addon2"></form:input>
</div>
<br>
...
<div class="input-group">
  ...
  <form:input type="text" class="form-control" path="imageurl" placeholder="Enter image url" aria-describedby="sizing-addon2"></form:input>
</div>
<br>
<div class="input-group">
...
<div class="form-group">
  ...
  <form:textarea class="form-control" rows="5" path="mainstory" id="comment"></form:textarea>
</div>
